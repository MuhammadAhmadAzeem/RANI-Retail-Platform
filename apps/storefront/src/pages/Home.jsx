...
const categories = [
    {
        title: "Men",
        subtitle: "Classic Pakistani menswear",
        image:
            "https://images.pexels.com/photos/35565657/pexels-photo-35565657.jpeg?auto=compress&cs=tinysrgb&w=1200",
    },
    {
        title: "Women",
    ...
    {
        title: "Unstitched",
        subtitle: "Prints, fabrics & textures",
        image:
...
const featuredProducts = [
    {
        ...
        price: "Rs. 4,999",
        image:
            "https://images.pexels.com/photos/35562718/pexels-photo-35562718.jpeg?auto=compress&cs=tinysrgb&w=900",
    },
    {
        ...
        price: "Rs. 5,499",
        image:
            "https://images.pexels.com/photos/20777169/pexels-photo-20777169.jpeg?auto=compress&cs=tinysrgb&w=900",
    },
    {
        name: "Signature Salwar Kameez",
        category: "Women",
        price: "Rs. 6,999",
        image:
            "https://images.pexels.com/photos/25184992/pexels-photo-25184992.jpeg?auto=compress&cs=tinysrgb&w=900",
    },
    {
        ...
        price: "Rs. 7,499",
        image:
            "https://images.pexels.com/photos/31323178/pexels-photo-31323178.jpeg?auto=compress&cs=tinysrgb&w=900",
    },
];
      ...
      ========================================================= */}
            <section className="relative isolate overflow-hidden bg-charcoal text-white">
                <div className="mx-auto grid min-h-[680px] max-w-[1440px] lg:grid-cols-[0.9fr_1.1fr]">
                    <div className="order-2 flex items-center px-6 py-16 sm:px-10 lg:order-1 lg:px-14 xl:px-20">
                        <div className="max-w-xl animate-slide-up">
                            ...
                            <h1 className="mt-7 font-heading text-5xl font-medium leading-[1.02] tracking-[-0.03em] sm:text-6xl lg:text-7xl">
                                Crafted for the way you carry tradition.
                            </h1>

                            <p className="mt-6 max-w-lg text-base leading-7 text-white/65 sm:text-lg">
                                Discover refined Pakistani fashion, timeless silhouettes and
                                elevated eastern wear curated for the modern wardrobe.
                            </p>
                    ...
                    <div className="order-1 flex min-h-[420px] items-center justify-center bg-[#e8e1d6] lg:order-2 lg:min-h-full">
                        <img
                            src="https://images.pexels.com/photos/36325924/pexels-photo-36325924.jpeg?auto=compress&cs=tinysrgb&w=1800"
                            alt="Pakistani woman wearing elegant traditional eastern fashion"
                            width="1800"
                            height="2700"
                            loading="eager"
                            fetchPriority="high"
                            decoding="async"
                            className="h-full max-h-[680px] w-full object-contain object-center"
                        />
                    </div>
                </div>
            </section>
            ...
            <section className="border-b border-border bg-background">
                <div className="mx-auto grid max-w-[1440px] divide-y divide-border sm:grid-cols-3 sm:divide-x sm:divide-y-0">
                    {[
                        [
                            "Premium Quality",
                            "Thoughtfully selected fabrics & finishes",
                        ],
                        [
                            "Nationwide Delivery",
                        ...
                        [
                            "Easy Returns",
                            "Simple exchange & return support",
                        ],
                    ].map(([title, text]) => (
                        <div
                            key={title}
                    ...
                    {categories.map((category) => (
                        ...
                        >
                            <div className="aspect-[4/5] overflow-hidden bg-surface-muted">
                                <img
                                    src={category.image}
                                    alt={`${category.title} Pakistani fashion collection`}
                                    width="1200"
                                    height="1500"
                                    loading="lazy"
                                    decoding="async"
                            ...
                            <div className="absolute inset-x-0 bottom-0 bg-linear-to-t from-black/70 via-black/25 to-transparent p-6 pt-24 text-white">
                        ...
                        {featuredProducts.map((product) => (
                            ...
                            >
                                <div className="relative aspect-[3/4] overflow-hidden bg-background">
                                    <img
                                        src={product.image}
                                        alt={`${product.name} by Bajwa's Collection`}
                                        width="900"
                                        height="1200"
                                        loading="lazy"
                                        decoding="async"
            ...
            <section className="mx-auto max-w-[1440px] px-5 py-20 sm:px-8 lg:py-24">
                <div className="grid overflow-hidden bg-primary text-white lg:grid-cols-[1fr_0.9fr]">
                    <div className="flex items-center px-6 py-14 sm:px-10 lg:px-16">
                        <div className="max-w-xl">
                            ...
                            <h2 className="mt-4 font-heading text-4xl font-medium leading-tight sm:text-5xl">
                                Timeless eastern wear, thoughtfully presented.
                            </h2>

                            <p className="mt-5 max-w-lg text-sm leading-7 text-white/70 sm:text-base">
                                From classic shalwar kameez to elegant embroidered pieces,
                                explore a refined edit inspired by Pakistani style and
                                contemporary living.
                            </p>
                    ...
                    <div className="min-h-[360px] lg:min-h-[520px]">
                        <img
                            src="https://images.pexels.com/photos/31874448/pexels-photo-31874448.jpeg?auto=compress&cs=tinysrgb&w=1400"
                            alt="Traditional Pakistani fashion editorial in Lahore"
                            width="1400"
                            height="2100"
                            loading="lazy"
                            decoding="async"
            ...
            <section className="border-y border-border bg-background">
                <div className="mx-auto max-w-[900px] px-5 py-20 text-center sm:px-8 lg:py-24">
                    ...
                    <p className="mx-auto mt-4 max-w-xl text-sm leading-7 text-text-muted sm:text-base">
                        ...
                        offers from Bajwa's Collection.
                    </p>
